...
Isadmin=$(curl -sS https://raw.githubusercontent.com/bulevpn/v5/main/ipvps | grep $MYIP | awk '{print $5}')
...
Exp1=$(curl https://raw.githubusercontent.com/bulevpn/v5/main/ipvps | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
    sts="${Info}"
else
    sts="${Error}"
...
clear
status=$( curl -sS https://raw.githubusercontent.com/bulevpn/v5/main/status )
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
