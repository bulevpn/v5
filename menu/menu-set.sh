...
echo -e "     ${BICyan}[${BIWhite}12${BICyan}] Registrasi Ip Baru (${BIRed}For Admin Only${BICyan})${NC}"
echo -e "     ${BICyan}[${BIWhite}13${BICyan}] Webmin Menu      "
echo -e "     ${BICyan}[${BIWhite}14${BICyan}] Setting Jam Auto Reboot"
...
0) clear ; menu ; exit ;;
x) exit ;;
*) echo -e "" ; echo "Kamu salah tekan sayangku" ; sleep 1 ; menu ;;
esac
