...
curl -sS https://raw.githubusercontent.com/bulevpn/v5/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/bulevpn/v5/main/ssh/nginx.conf"
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/bulevpn/v5/main/ssh/newudpgw"
...
#OpenVPN
wget https://raw.githubusercontent.com/bulevpn/v5/main/OPENVPN/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/bulevpn/v5/main/ssh/issue.net"
chmod +x /etc/issue.net
echo "Banner /etc/issue.net" >> /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/bulevpn/v5/main/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
wget -O menu-trial "https://raw.githubusercontent.com/bulevpn/v5/main/menu/menu-trial.sh"
...
wget -O delete "https://raw.githubusercontent.com/bulevpn/v5/main/ssh/delete.sh"
wget -O autokill "https://raw.githubusercontent.com/bulevpn/v5/main/ssh/autokill.sh"
wget -O ceklim "https://raw.githubusercontent.com/bulevpn/v5/main/ssh/ceklim.sh"
wget -O tendang "https://raw.githubusercontent.com/bulevpn/v5/main/ssh/tendang.sh"
...
wget -O about "https://raw.githubusercontent.com/bulevpn/v5/main/menu/about.sh"
...
wget -O renew-tr "https://raw.githubusercontent.com/bulevpn/v5/main/xray/renew-tr.sh"
wget -O cek-tr "https://raw.githubusercontent.com/bulevpn/v5/main/xray/cek-tr.sh"
wget -O addtrgo "https://raw.githubusercontent.com/bulevpn/v5/main/xray/addtrgo.sh"
wget -O trialtrojango "https://raw.githubusercontent.com/bulevpn/v5/main/xray/trialtrojango.sh"
...
wget -O menu-uuid "https://raw.githubusercontent.com/bulevpn/v5/main/menu/menu-uuid.sh"
wget -O m-theme "https://raw.githubusercontent.com/bulevpn/v5/main/menu/m-theme.sh"
...
wget -O menu-l2tp "https://raw.githubusercontent.com/bulevpn/v5/main/wireguard/menu-l2tp.sh"
